...
<%
// Trang form.jsp dùng chung cho chức năng tạo mới và sửa tin tức // Ghi vào request scope một dấu hiệu (isEdit) để phân biệt // Nếu đang ở chế độ sửa tin tức, trong request scope sẽ có đối tượng News // chứa thông tin để hiển thị lên form // request là biến ngầm định có sẵn trong trang request.setAttribute("isEdit", request.getAttribute("news") != null);
%>
<html>
<head>
<meta charset="UTF-8">
